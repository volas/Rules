...
1. Самоантагонизм (self-antagging) запрещен. Если игра не выдала вам роль антагониста — вы не являетесь им.
   ...
   - Использование бомб допустимо только на полигоне или астероиде. Если вы хотите взорвать бомбу на станции по какой-либо причине, например, для уничтожения блоба или ксеноморфов, свяжитесь с Главами на станции и оповестите администрацию.
   - Не разрешена кража [предметов высокого риска](https://wiki.taucetistation.org/High-risk_items) и других уникальных предметов, отсутствие которых может сказаться на развитии раунда.
