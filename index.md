...
1. Самоантагонизм (self-antagging) запрещен. Если игра не выдала вам роль антагониста — вы не являетесь им.
   ...
   - Кража [предметов высокого риска](https://wiki.taucetistation.org/High-risk_items) и других уникальных предметов, отсутствие которых может сказаться на развитии раунда, считается самоантазонизмом.
   - Допускается помощь антагонистам, но она должна быть скорее пассивной. Если ваши действия или бездействие при этом угрожают другим игрокам или станции, то у вас должны быть достаточные причины для такого поведения.
