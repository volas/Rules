...
1. Под запретом отыгрыш близких и родственных отношений, согласованных вне IC-рамок текущего раунда (мета-дружба).
   - Но вы всё еще можете отыгрывать, что знакомы с другими персонажами, если другой игрок не против. Это не должно использоваться для получения игровых преимуществ (выдачи предметов, доступов, помощь в IC-конфликтах, и так далее).

1. Серьезные конфликты должны развиваться только постепенно и только соразмерно внутриигровой мотивации оппонентов. Конфликты должны развиваться только в рамках текущего раунда, перенос и продолжение конфликтов с предыдущих раундов (мета-хейт) запрещены.
